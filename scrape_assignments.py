...
for filename in os.listdir(html_folder):
    if filename.endswith(".html"):  
        ...
        for question_block in soup.find_all("div", class_="mb-3"):
            ...
            # Extract answer from the <textarea>, if available
            answer_tag = question_block.find("textarea")
            answer_text = answer_tag.get("value", "").strip() if answer_tag else "Answer not provided"
